...
class install(Command):
    ...
    user_options = [
        ...
        ('index=', None, "(Unix only) index directory to install under"),
        # Or, just set the base director(y|ies)
        (
            'install-base=',
            None,
            "base installation directory (instead of --prefix or --index)",
        ),
        (
            'install-platbase=',
            None,
            "base installation directory for platform-specific files "
            + "(instead of --exec-prefix or --index)",
        ),
    ...
    def initialize_options(self):
        ...
        # scheme implied by prefix/exec-prefix/index and the contents of
    ...
    def finalize_options(self):
        ...
        if (self.prefix or self.exec_prefix or self.home) and (
            ...
            raise DistutilsOptionError(
                "must supply either prefix/exec-prefix/index or "
                + "install-base/install-platbase -- not both"
            )

        if self.home and (self.prefix or self.exec_prefix):
            raise DistutilsOptionError(
                "must supply either index or prefix/exec-prefix -- not both"
            )
        ...
        if self.user and (
            ...
            raise DistutilsOptionError(
                ...
                "exec_prefix/index, or install_(plat)base"
            )
        ...
        # input a heady brew of prefix, exec_prefix, index, install_base,
        ...
        # Create directories in the index dir:
        if self.user:
